...
const Inventory = () => {
  ...
  const columnsToDisplay = ["productcode", "name", "quantity", "onhold", "category"];
  ...
  return (
    <div className="container mx-auto p-4">
      <div className="w-[90%] flex justify-around items-center">
        <h1 onClick={handleCreateProduct} className="cursor-pointer text-blue-500 mb-4">Create Inventory</h1>
        <div className="mb-4">
          <input
            type="text"
      ...
      <HeroTable data={data} columns={columnsToDisplay} handleUpdate={handleUpdate} />
      <nav className="mt-4">
